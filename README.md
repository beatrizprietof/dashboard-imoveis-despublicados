...
*  **Gestão de Criticidade:** Identificação do volume de ocorrências por nível de risco e mapeamento dos **principais motivos de criticidade**.
*  **Analistas Ofensores & Reincidentes:** Painel de rastreamento de desvios recorrentes para suporte em auditorias operacionais.
*  **Gestão de Consequência:** Módulo para acompanhamento e controle das tratativas aplicadas aos casos fora do padrão.
